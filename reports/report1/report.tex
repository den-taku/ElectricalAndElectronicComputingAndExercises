\documentclass[uplatex, dvipdfmx, 11pt,a4j, titlepage]{jsarticle}
    ...
    \begin{center}
        \begin{tabular}{c}
            ...
            \begin{minipage}{0.33\hsize}
                \begin{center}
                    \includegraphics[clip, width=4.5cm]{./bisection.pdf}
            ...
            \begin{minipage}{0.33\hsize}
                \begin{center}
                    \includegraphics[clip, width=4.5cm]{./bisection111.pdf}
