...
//     let _ = fg.show();
   ...
   println!("ZZZZZZZZZZZZ f32 ZZZZZZZZZZZZZzz");
    ...
    println!("Jacobi:       {}", (&jacobi.approximate_answer() - &Matrix::append(9, 1, vec![1.0; 9])).norm2::<f32>());
    println!("Gauss-Seidek: {}", (&gauss_seidel.approximate_answer() - &Matrix::append(9, 1, vec![1.0; 9])).norm2::<f32>());
    println!("SOR:          {}", (&sor.approximate_answer() - &Matrix::append(9, 1, vec![1.0; 9])).norm2::<f32>());
//     let mut fg = Figure::new();
